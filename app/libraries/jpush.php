...
class jpush {
	private $_masterSecret = '01febf80d0eb401661e5a4e5';
	private $_appkeys = '02955010630c41b5dffda312';
	 ...
	 */
	function send($receiver_type = 1, $receiver_value = '', $msg_type = 1, $msg_content = '', $platform = 'ios') {
		$platform=$platform?$platform:$this->_platform;
		$sendno=time();
